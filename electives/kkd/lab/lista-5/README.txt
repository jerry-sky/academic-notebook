...
Na standardowe wyjście błędów wypisywane są kolejno znalezione lepsze ustawienia ilości bitów na każdy z poszczególnych kolorów. Jeśli jest taka potrzeba, oczywiście można standardowe wyjście błędów przekierować na `/dev/null` celem otrzymania mniejszej liczby linijek wyjścia programu.
